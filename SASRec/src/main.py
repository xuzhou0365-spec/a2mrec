...
def main():
    ...
    parser.add_argument("--lr_adv", type=float, default=2e-3, help="learning rate of adam")  #1e-3  2e-3
    ...
    parser.add_argument("--attention_probs_dropout_prob", type=float, default=0.1, help="attention dropout p")  #0.1
    parser.add_argument("--hidden_dropout_prob", type=float, default=0.1, help="hidden dropout p")  #0.1
    parser.add_argument("--beta", type=float, default=0.4, help="beta value distributions for beta")
    parser.add_argument("--rate_min", type=float, default=0.2, help="min ratio for two operators")
    parser.add_argument("--rate_max", type=float, default=0.71, help="max ratio for two operators")
    ############################################
